	...
	tinymce.PluginManager.add( 'boc_shortcodes_dropdown', function( editor, url ) {
		editor.addButton( 'boc_shortcodes_dropdown', {
			...
			menu: [
				...
				text: 'Icon',
					onclick: function() {
						editor.insertContent('[boc_icon size="normal" icon_position="center" icon_color="#333333" has_icon_bg="" icon_bg="#ffffff" icon_bg_border="#ffffff" border_radius="100%" icon="icon-star" margin_top="" margin_bottom=""]');
					}
				},
				{
				text: 'Spacing',
				...
				text: 'Table',
					onclick: function() {
						editor.insertContent('<table class="fortuna_table" width="100%"><tr><th>Header 1</th><th>Header 2</th><th>Header 3</th></tr><tr><td>Item 1</td><td>Description of Item 1</td><td>$200</td></tr><tr><td>Item 2</td><td>Description of Item 2</td><td>$300</td></tr></table>');
					}
				},
				{
				text: 'Highlight',
