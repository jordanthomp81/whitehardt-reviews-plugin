...
class boc_latest extends WP_Widget {
        ...
        function widget($args, $instance) {
            ...
            <div class="boc_latest_posts section">
                <a href="<?php the_permalink() ?>"><?php the_post_thumbnail('boc_thumb'); ?></a>
...
class contact_info_widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		<div class="boc_contact_icon"><span class="icon icon-mail2"></span> <?php echo antispambot(esc_html($instance['email'])); ?></div>
		<?php endif; ?>
