...
get_header();
	...
	<div>
				...
				<script type="text/javascript">
					...
					<?php 	
							// TODO remove for prod - checks to show different maps
							// Contact page 2 - show grey map
							if(is_page( 22564 )){
							...
							if (status == google.maps.GeocoderStatus.OK) {
							  ...
							  map.setCenter(results[0].geometry.location);
								...
								var marker = new google.maps.Marker({
									...
									map: map,
									title:address,
									title: 'Fortuna Marker',
									icon: '<?php echo esc_url(get_template_directory_uri()); ?>/images/custom_marker1.png',
